!function(t, e, i) {
    ...
    if (!function(t,e) {
        ...
        function r() {
            G.removeEventListener("DOMContentLoaded", r, !1),
        ...
        function l(t, e, i) {
            ...
            if (void 0 === i && 1 === t.nodeType)
                if (n = "data-" + e.replace(wt, "-$1").toLowerCase(),
                i = t.getAttribute(n),
                "string" == typeof i) {
                    try {
                        i = "true" === i || "false" !== i && ("null" === i ? null : +i + "" === i ? +i : bt.test(i) ? Z.parseJSON(i) : i)
                    } catch (s) {}
                    yt.set(t, e, i)
                } else
                    i = void 0;
        ...
        function w(t) {
            var e = G
              , i = Rt[t];
            return i || (i = b(t, e),
            "none" !== i && i || (Pt = (Pt || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),
        ...
        function x(t, e, i) {
            ...
            i && ("" !== r || Z.contains(t.ownerDocument, t) || (r = Z.style(t, e)),
            Wt.test(r) && Ht.test(e) && (n = a.width,
            s = a.minWidth,
            o = a.maxWidth,
        ...
        function _(t, e, i, n, s) {
            for (var o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, r = 0; 4 > o; o += 2)
                "margin" === i && (r += Z.css(t, i + Tt[o], !0, s)),
                n ? ("content" === i && (r -= Z.css(t, "padding" + Tt[o], !0, s)),
                "margin" !== i && (r -= Z.css(t, "border" + Tt[o] + "Width", !0, s))) : (r += Z.css(t, "padding" + Tt[o], !0, s),
                "padding" !== i && (r += Z.css(t, "border" + Tt[o] + "Width", !0, s)));
            return r
        }
        function k(t, e, i) {
            var n = !0
            ...
            if (0 >= s || null == s) {
                ...
                Wt.test(s))
                    return s;
                n = r && (J.boxSizingReliable() || s === t.style[e]),
                s = parseFloat(s) || 0
            }
        ...
        function $(t, e) {
            for (var i, n, s, o = [], r = 0, a = t.length; a > r; r++)
                n = t[r],
                n.style && (o[r] = vt.get(n, "olddisplay"),
                i = n.style.display,
                e ? (o[r] || "none" !== i || (n.style.display = ""),
                "" === n.style.display && Ct(n) && (o[r] = vt.access(n, "olddisplay", w(n.nodeName)))) : (s = Ct(n),
        ...
        function M(t, e, i) {
            var n, s, o, r, a, l, h, c, u = this, d = {}, p = t.style, f = t.nodeType && Ct(t), g = vt.get(t, "fxshow");
            i.queue || (a = Z._queueHooks(t, "fx"),
            ...
            h = Z.css(t, "display"),
            c = "none" === h ? vt.get(t, "olddisplay") || w(t.nodeName) : h,
            ...
            if (Z.isEmptyObject(d))
                "inline" === ("none" === h ? w(t.nodeName) : h) && (p.display = h);
            else {
        ...
        function O(t, e, i) {
            var n, s, o = 0, r = ee.length, a = Z.Deferred().always(function() {
                delete l.elem
            }), l = function() {
                if (s)
                    return !1;
                for (var e = Jt || S(), i = Math.max(0, h.startTime + h.duration - e), n = i / h.duration || 0, o = 1 - n, r = 0, l = h.tweens.length; l > r; r++)
                    h.tweens[r].run(o);
                return a.notifyWith(t, [h, o, i]),
                1 > o && l ? i : (a.resolveWith(t, [h]),
                !1)
            }, h = a.promise({
                elem: t,
                props: Z.extend({}, e),
        ...
        function R(t, e, i, n) {
            ...
            if (Z.isArray(e))
                Z.each(e, function(e, s) {
                    i || De.test(t) ? n(t, s) : R(t + "[" + ("object" == typeof s ? e : "") + "]", s, i, n)
                });
        ...
        Z.extend = Z.fn.extend = function() {
            ...
            r = arguments[a] || {},
            a++),
            "object" == typeof r || Z.isFunction(r) || (r = {}),
            a === l && (r = this,
            a--); l > a; a++)
                if (null != (t = arguments[a]))
                    for (e in t)
                        i = r[e],
                        n = t[e],
                        r !== n && (h && n && (Z.isPlainObject(n) || (s = Z.isArray(n))) ? (s ? (s = !1,
                        o = i && Z.isArray(i) ? i : []) : o = i && Z.isPlainObject(i) ? i : {},
                        r[e] = Z.extend(h, o, n)) : void 0 !== n && (r[e] = n));
            return r
        }
        ,
        Z.extend({
            ...
            globalEval: function(t) {
                ...
                e.text = t,
                G.head.appendChild(e).parentNode.removeChild(e)) : i(t))
            },
            ...
            makeArray: function(t, e) {
                var n = e || [];
                return null != t && (i(Object(t)) ? Z.merge(n, "string" == typeof t ? [t] : t) : V.call(n, t)),
                n
            },
        ...
        var st = function(t) {
            function e(t, e, i, n) {
                ...
                if ((e ? e.ownerDocument || e : R) !== M && A(e),
                e = e || M,
                i = i || [],
                a = e.nodeType,
                ...
                if (!n && O) {
                        ...
                        if (r = s[1]) {
                            if (9 === a) {
                                ...
                                if (o.id === r)
                                    return i.push(o),
                                    i
                            } else if (e.ownerDocument && (o = e.ownerDocument.getElementById(r)) && U(e, o) && o.id === r)
                                return i.push(o),
                                i
                        } else {
                            if (s[2])
                                ...
                                i;
                            if ((r = s[3]) && x.getElementsByClassName)
                    ...
                    if (x.qsa && (!F || !F.test(t))) {
                        ...
                        1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (h = _(t),
                            (u = e.getAttribute("id")) ? p = u.replace(wt, "\\$&") : e.setAttribute("id", p),
                            p = "[id='" + p + "'] ",
                            l = h.length; l--; )
                                h[l] = p + d(h[l]);
            ...
            function v(t, e, i, s, o, r) {
                ...
                o && !o[P] && (o = v(o, r)),
                n(function(n, r, a, l) {
                    var h, c, u, d = [], p = [], f = r.length, v = n || g(e || "*", a.nodeType ? [a] : a, []), y = !t || !n && e ? v : m(v, d, t, a, l), b = i ? o || (n ? t : f || s) ? [] : r : y;
                    if (i && i(y, b, a, l),
                    s)
                        for (h = m(b, p),
                        s(h, [], a, l),
                    ...
                    if (n) {
                        if (o || t) {
                            ...
                            for (c = b.length; c--; )
                                (u = b[c]) && (h = o ? tt(n, u) : d[c]) > -1 && (n[h] = !(r[h] = u))
                        }
                    } else
                        b = m(b === r ? b.splice(f, b.length) : b),
                        o ? o(null, r, b, l) : K.apply(r, b)
                })
            }
            function y(t) {
                for (var e, i, n, s = t.length, o = T.relative[t[0].type], r = o || T.relative[" "], a = o ? 1 : 0, l = p(function(t) {
                    return t === e
                }, r, !0), h = p(function(t) {
                    return tt(e, t) > -1
                    ...
                    if (i = T.relative[t[a].type])
                        ...
                        if (i = T.filter[t[a].type].apply(null, t[a].matches),
                        i[P]) {
            ...
            function b(t, i) {
                var s = i.length > 0
                  ...
                  , r = function(n, r, a, l, h) {
                    var c, u, d, p = 0, f = "0", g = n && [], v = [], y = E, b = n || o && T.find.TAG("*", h), w = H += null == y ? 1 : Math.random() || .1, x = b.length;
                    for (h && (E = r !== M && r); f !== x && null != (c = b[f]); f++) {
                        if (o && c) {
                            for (u = 0; d = t[u++]; )
                                if (d(c, r, a)) {
                                    l.push(c);
            ...
            var w, x, T, C, D, _, k, $, E, S, N, A, M, j, O, F, I, L, U, P = "sizzle" + 1 * new Date, R = t.document, H = 0, W = 0, q = i(), z = i(), V = i(), B = function(t, e) {
                return t === e && (N = !0),
                0
            }, Y = 1 << 31, X = {}.hasOwnProperty, Q = [], J = Q.pop, G = Q.push, K = Q.push, Z = Q.slice, tt = function(t, e) {
                for (var i = 0, n = t.length; n > i; i++)
                    if (t[i] === e)
                        return i;
                return -1
            }, et = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", it = "[\\x20\\t\\r\\n\\f]", nt = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", st = nt.replace("w", "w#"), ot = "\\[" + it + "*(" + nt + ")(?:" + it + "*([*^$|!~]?=)" + it + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + st + "))|)" + it + "*\\]", rt = ":(" + nt + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ot + ")*)|.*)\\)|)", at = new RegExp(it + "+","g"), lt = new RegExp("^" + it + "+|((?:^|[^\\\\])(?:\\\\.)*)" + it + "+$","g"), ht = new RegExp("^" + it + "*," + it + "*"), ct = new RegExp("^" + it + "*([>+~]|" + it + ")" + it + "*"), ut = new RegExp("=" + it + "*([^\\]'\"]*?)" + it + "*\\]","g"), dt = new RegExp(rt), pt = new RegExp("^" + st + "$"), ft = {
                ID: new RegExp("^#(" + nt + ")"),
                CLASS: new RegExp("^\\.(" + nt + ")"),
            ...
            }, gt = /^(?:input|select|textarea|button)$/i, mt = /^h\d$/i, vt = /^[^{]+\{\s*\[native \w/, yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, bt = /[+~]/, wt = /'|\\/g, xt = new RegExp("\\\\([\\da-f]{1,6}" + it + "?|(" + it + ")|.)","ig"), Tt = function(t, e, i) {
                var n = "0x" + e - 65536;
            ...
            try {
                K.apply(Q = Z.call(R.childNodes), R.childNodes),
            ...
            A = e.setDocument = function(t) {
                ...
                x.getElementsByClassName = vt.test(n.getElementsByClassName),
                x.getById = s(function(t) {
                    return j.appendChild(t).id = P,
                ...
                I = [],
                F = [],
                (x.qsa = vt.test(n.querySelectorAll)) && (s(function(t) {
                    j.appendChild(t).innerHTML = "<a id='" + P + "'></a><select id='" + P + "-\f]' msallowcapture=''><option selected=''></option></select>",
                    t.querySelectorAll("[msallowcapture^='']").length && F.push("[*^$]=" + it + "*(?:''|\"\")"),
                    t.querySelectorAll("[selected]").length || F.push("\\[" + it + "*(?:value|" + et + ")"),
                    t.querySelectorAll("[id~=" + P + "-]").length || F.push("~="),
                    t.querySelectorAll(":checked").length || F.push(":checked"),
                    t.querySelectorAll("a#" + P + "+*").length || F.push(".#.+[+~]")
                }),
                s(function(t) {
                ...
                (x.matchesSelector = vt.test(L = j.matches || j.webkitMatchesSelector || j.mozMatchesSelector || j.oMatchesSelector || j.msMatchesSelector)) && s(function(t) {
                ...
                U = e || vt.test(j.contains) ? function(t, e) {
                ...
                B = e ? function(t, e) {
                    ...
                    1 & i || !x.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === R && U(R, t) ? -1 : e === n || e.ownerDocument === R && U(R, e) ? 1 : S ? tt(S, t) - tt(S, e) : 0 : 4 & i ? -1 : 1)
                }
                : function(t, e) {
                    if (t === e)
                        return N = !0,
                    ...
                    if (!o || !a)
                        return t === n ? -1 : e === n ? 1 : o ? -1 : a ? 1 : S ? tt(S, t) - tt(S, e) : 0;
                    if (o === a)
                        return r(t, e);
            ...
            e.matchesSelector = function(t, i) {
                if ((t.ownerDocument || t) !== M && A(t),
                i = i.replace(ut, "='$1']"),
                !(!x.matchesSelector || !O || I && I.test(i) || F && F.test(i)))
                    try {
                        var n = L.call(t, i);
            ...
            e.contains = function(t, e) {
                return (t.ownerDocument || t) !== M && A(t),
                U(t, e)
            }
            ,
            e.attr = function(t, e) {
            ...
            T = e.selectors = {
                ...
                preFilter: {
                    ...
                    PSEUDO: function(t) {
                        var e, i = !t[6] && t[2];
                        return ft.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && dt.test(i) && (e = _(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                        t[2] = i.slice(0, e)),
                        t.slice(0, 3))
                    }
                },
                filter: {
                    ...
                    CHILD: function(t, e, i, n, s) {
                        ...
                        : function(e, i, l) {
                            var h, c, u, d, p, f, g = o !== r ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a;
                            if (m) {
                                if (o) {
                                    for (; g; ) {
                                        for (u = e; u = u[g]; )
                                ...
                                r && y) {
                                    ...
                                    p = h[0] === H && h[1],
                                    d = h[0] === H && h[2],
                                    u = p && m.childNodes[p]; u = ++p && u && u[g] || (d = p = 0) || f.pop(); )
                                        if (1 === u.nodeType && ++d && u === e) {
                                            c[t] = [H, p, d];
                                            break
                                        }
                                } else if (y && (h = (e[P] || (e[P] = {}))[t]) && h[0] === H)
                                    d = h[1];
                                else
                                    for (; (u = ++p && u && u[g] || (d = p = 0) || f.pop()) && ((a ? u.nodeName.toLowerCase() !== v : 1 !== u.nodeType) || !++d || (y && ((u[P] || (u[P] = {}))[t] = [H, d]),
                                    u !== e)); )
                                        ;
                                return d -= s,
                                d === n || d % n === 0 && d / n >= 0
                    ...
                    PSEUDO: function(t, i) {
                        ...
                        return o[P] ? o(i) : o.length > 1 ? (s = [t, t, "", i],
                        T.setFilters.hasOwnProperty(t.toLowerCase()) ? n(function(t, e) {
                ...
                pseudos: {
                    ...
                    lang: n(function(t) {
                        ...
                        function(e) {
                            var i;
                            do
                                if (i = O ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang"))
            ...
            _ = e.tokenize = function(t, i) {
                ...
                h = T.preFilter; a; ) {
                    ...
                    a = a.slice(n.length));
                    for (r in T.filter)
                        !(s = ft[r].exec(a)) || h[r] && !(s = h[r](s)) || (n = s.shift(),
                        o.push({
                            value: n,
                            type: r,
                            matches: s
            ...
            $ = e.select = function(t, e, i, n) {
                var s, o, r, a, l, h = "function" == typeof t && t, u = !n && _(t = h.selector || t);
                if (i = i || [],
                1 === u.length) {
                    if (o = u[0] = u[0].slice(0),
                    o.length > 2 && "ID" === (r = o[0]).type && x.getById && 9 === e.nodeType && O && T.relative[o[1].type]) {
                        if (e = (T.find.ID(r.matches[0].replace(xt, Tt), e) || [])[0],
                        !e)
                            return i;
                        h && (e = e.parentNode),
                        t = t.slice(o.shift().value.length)
                    }
                    for (s = ft.needsContext.test(t) ? 0 : o.length; s-- && (r = o[s],
                    !T.relative[a = r.type]); )
                        if ((l = T.find[a]) && (n = l(r.matches[0].replace(xt, Tt), bt.test(o[0].type) && c(e.parentNode) || e))) {
                            if (o.splice(s, 1),
                            t = n.length && d(o),
                            !t)
                                return K.apply(i, n),
                ...
                return (h || k(t, u))(n, e, !O, i, bt.test(t) && c(e.parentNode) || e),
                i
            }
            ,
        ...
        var lt, ht = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ct = Z.fn.init = function(t, e) {
            ...
            if ("string" == typeof t) {
                ...
                if (i[1]) {
                    ...
                    Z.merge(this, Z.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : G, !0)),
                    rt.test(i[1]) && Z.isPlainObject(e))
                        for (i in e)
                            Z.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                    return this
                }
                return n = G.getElementById(i[2]),
        ...
        Z.fn.extend({
            ...
            index: function(t) {
                return t ? "string" == typeof t ? B.call(Z(t), this[0]) : B.call(this, t.jquery ? t[0] : t) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
            },
            add: function(t, e) {
        ...
        Z.extend({
            ...
            when: function(t) {
                var e, i, n, s = 0, o = q.call(arguments), r = o.length, a = 1 !== r || t && Z.isFunction(t.promise) ? r : 0, l = 1 === a ? t : Z.Deferred(), h = function(t, i, n) {
                    return function(s) {
                        i[t] = this,
                ...
                if (r > 1)
                    ...
                    i = new Array(r),
                    n = new Array(r); r > s; s++)
                        o[s] && Z.isFunction(o[s].promise) ? o[s].promise().done(h(s, n, o)).fail(l.reject).progress(h(s, i, e)) : --a;
        ...
        Z.extend({
            ...
            ready: function(t) {
                ...
                t !== !0 && --Z.readyWait > 0 || (gt.resolveWith(G, [Z]),
                Z.fn.triggerHandler && (Z(G).triggerHandler("ready"),
                Z(G).off("ready"))))
            }
        }),
        Z.ready.promise = function(e) {
            return gt || (gt = Z.Deferred(),
            "complete" === G.readyState ? setTimeout(Z.ready) : (G.addEventListener("DOMContentLoaded", r, !1),
        ...
        Z.event = {
            ...
            add: function(t, e, i, n, s) {
                var o, r, a, l, h, c, u, d, p, f, g, m = vt.get(t);
                if (m)
                    for (i.handler && (o = i,
                    i = o.handler,
                    s = o.selector),
                    ...
                    h = e.length; h--; )
                        ...
                        (d = l[p]) || (d = l[p] = [],
                        d.delegateCount = 0,
                        u.setup && u.setup.call(t, n, f, r) !== !1 || t.addEventListener && t.addEventListener(p, r, !1)),
            ...
            remove: function(t, e, i, n, s) {
                var o, r, a, l, h, c, u, d, p, f, g, m = vt.hasData(t) && vt.get(t);
                if (m && (l = m.events)) {
                    for (e = (e || "").match(pt) || [""],
                    h = e.length; h--; )
                        if (a = St.exec(e[h]) || [],
                        ...
                        p) {
                            ...
                            r && !d.length && (u.teardown && u.teardown.call(t, f, m.handle) !== !1 || Z.removeEvent(t, p, m.handle),
                            delete l[p])
                        } else
                            for (p in l)
            ...
            trigger: function(e, i, n, s) {
                var o, r, a, l, h, c, u, d = [n || G], p = Q.call(e, "type") ? e.type : e, f = Q.call(e, "namespace") ? e.namespace.split(".") : [];
                if (r = a = n = n || G,
                3 !== n.nodeType && 8 !== n.nodeType && !Et.test(p + Z.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."),
                p = f.shift(),
                f.sort()),
                h = p.indexOf(":") < 0 && "on" + p,
                ...
                s || !u.trigger || u.trigger.apply(n, i) !== !1)) {
                    if (!s && !u.noBubble && !Z.isWindow(n)) {
                        ...
                        Et.test(l + p) || (r = r.parentNode); r; r = r.parentNode)
                            d.push(r),
                            a = r;
                    ...
                    for (o = 0; (r = d[o++]) && !e.isPropagationStopped(); )
                        ...
                        c = (vt.get(r, "events") || {})[e.type] && vt.get(r, "handle"),
                        c && c.apply(r, i),
                        c = h && r[h],
                        c && c.apply && Z.acceptData(r) && (e.result = c.apply(r, i),
                        e.result === !1 && e.preventDefault());
                    return e.type = p,
                    s || e.isDefaultPrevented() || u._default && u._default.apply(d.pop(), i) !== !1 || !Z.acceptData(n) || h && Z.isFunction(n[p]) && !Z.isWindow(n) && (a = n[h],
                    a && (n[h] = null),
                    Z.event.triggered = p,
                    n[p](),
            ...
            dispatch: function(t) {
                t = Z.event.fix(t);
                var e, i, n, s, o, r = [], a = q.call(arguments), l = (vt.get(this, "events") || {})[t.type] || [], h = Z.event.special[t.type] || {};
                if (a[0] = t,
                t.delegateTarget = this,
                !h.preDispatch || h.preDispatch.call(this, t) !== !1) {
                    for (r = Z.event.handlers.call(this, t, l),
                    e = 0; (s = r[e++]) && !t.isPropagationStopped(); )
                        ...
                        i = 0; (o = s.handlers[i++]) && !t.isImmediatePropagationStopped(); )
                            ...
                            t.data = o.data,
                            n = ((Z.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, a),
            ...
            fix: function(t) {
                ...
                for (r || (this.fixHooks[s] = r = $t.test(s) ? this.mouseHooks : kt.test(s) ? this.keyHooks : {}),
                ...
                for (var s, o, r, a, l, h, c = e.createDocumentFragment(), u = [], d = 0, p = t.length; p > d; d++)
                    ...
                    s || 0 === s)
                        if ("object" === Z.type(s))
                            ...
                            r = (At.exec(s) || ["", ""])[1].toLowerCase(),
                            a = Ut[r] || Ut._default,
                            o.innerHTML = a[1] + s.replace(Nt, "<$1></$2>") + a[2],
                            h = a[0]; h--; )
                                o = o.lastChild;
        ...
        Z.fn.extend({
            ...
            remove: function(t, e) {
                for (var i, n = t ? Z.filter(t, this) : this, s = 0; null != (i = n[s]); s++)
                    ...
                    i.parentNode && (e && Z.contains(i.ownerDocument, i) && g(v(i, "script")),
            ...
            html: function(t) {
                return mt(this, function(t) {
                    ...
                    if (void 0 === t && 1 === e.nodeType)
                        return e.innerHTML;
                    if ("string" == typeof t && !jt.test(t) && !Ut[(At.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = t.replace(Nt, "<$1></$2>");
                        try {
                            for (; n > i; i++)
                                e = this[i] || {},
            ...
            domManip: function(t, e) {
                t = z.apply([], t);
                var i, n, s, o, r, a, l = 0, h = this.length, c = this, u = h - 1, d = t[0], g = Z.isFunction(d);
                if (g || h > 1 && "string" == typeof d && !J.checkClone && Ot.test(d))
                    return this.each(function(i) {
                        var n = c.eq(i);
                        g && (t[0] = d.call(this, i, n.html())),
                        n.domManip(t, e)
                    });
                ...
                n)) {
                    ...
                    if (o)
                        ...
                        l = 0; o > l; l++)
                            r = s[l],
                            Ft.test(r.type || "") && !vt.access(r, "globalEval") && Z.contains(a, r) && (r.src ? Z._evalUrl && Z._evalUrl(r.src) : Z.globalEval(r.textContent.replace(Lt, "")))
                }
                return this
            }
        }),
        Z.each({
            ...
            Z.fn[t] = function(t) {
                for (var i, n = [], s = Z(t), o = s.length - 1, r = 0; o >= r; r++)
        ...
        var Pt, Rt = {}, Ht = /^margin/, Wt = new RegExp("^(" + xt + ")(?!px)[a-z%]+$","i"), qt = function(e) {
        ...
        !function() {
            ...
            t.getComputedStyle && Z.extend(J, {
                ...
                reliableMarginRight: function() {
                    var e, i = r.appendChild(G.createElement("div"));
        ...
        Z.extend({
            ...
            style: function(t, e, i, n) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    ...
                    return e = Z.cssProps[a] || (Z.cssProps[a] = C(l, a)),
                    r = Z.cssHooks[e] || Z.cssHooks[a],
                    void 0 === i ? r && "get"in r && void 0 !== (s = r.get(t, !1, n)) ? s : l[e] : (o = typeof i,
                    "string" === o && (s = Bt.exec(i)) && (i = (s[1] + 1) * s[2] + parseFloat(Z.css(t, e)),
                    o = "number"),
                    void (null != i && i === i && ("number" !== o || Z.cssNumber[a] || (i += "px"),
                    J.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"),
                    r && "set"in r && void 0 === (i = r.set(t, i, n)) || (l[e] = i))))
                }
            },
            css: function(t, e, i, n) {
                var s, o, r, a = Z.camelCase(e);
                return e = Z.cssProps[a] || (Z.cssProps[a] = C(t.style, a)),
                r = Z.cssHooks[e] || Z.cssHooks[a],
                r && "get"in r && (s = r.get(t, !0, i)),
                void 0 === s && (s = x(t, e, n)),
                "normal" === s && e in Xt && (s = Xt[e]),
                "" === i || i ? (o = parseFloat(s),
        ...
        Z.each(["height", "width"], function(t, e) {
            Z.cssHooks[e] = {
                get: function(t, i, n) {
                    return i ? zt.test(Z.css(t, "display")) && 0 === t.offsetWidth ? Z.swap(t, Yt, function() {
                        return k(t, e, n)
                    }) : k(t, e, n) : void 0
                },
                set: function(t, i, n) {
                    var s = n && qt(t);
                    return D(t, i, n ? _(t, e, n, "border-box" === Z.css(t, "boxSizing", !1, s), s) : 0)
                }
            }
        }),
            ...
            Z.cssHooks[t + e] = {
                expand: function(i) {
                    for (var n = 0, s = {}, o = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++)
                        s[t + Tt[n] + e] = o[n] || o[n - 2] || o[0];
                    return s
                }
            },
            Ht.test(t) || (Z.cssHooks[t + e].set = D)
        }),
        Z.fn.extend({
            css: function(t, e) {
        ...
        Z.fx.step = {};
        var Jt, Gt, Kt = /^(?:toggle|show|hide)$/, Zt = new RegExp("^(?:([+-])=|)(" + xt + ")([a-z%]*)$","i"), te = /queueHooks$/, ee = [M], ie = {
            "*": [function(t, e) {
                ...
                if (r && r[3] !== o) {
                    ...
                    do
                        a = a || ".5",
                        r /= a,
                        Z.style(i.elem, t, r + o);
                    while (a !== (a = i.cur() / n) && 1 !== a && --l)
                }
                return s && (r = i.start = +r || +n || 0,
                i.unit = o,
        ...
        Z.fn.extend({
            ...
            finish: function(t) {
                return t !== !1 && (t = t || "fx"),
                this.each(function() {
                    var e, i = vt.get(this), n = i[t + "queue"], s = i[t + "queueHooks"], o = Z.timers, r = n ? n.length : 0;
                    for (i.finish = !0,
                    Z.queue(this, t, []),
        ...
        Z.extend({
            attr: function(t, e, i) {
                ...
                if (t && 3 !== o && 8 !== o && 2 !== o)
                    return typeof t.getAttribute === _t ? Z.prop(t, e, i) : (1 === o && Z.isXMLDoc(t) || (e = e.toLowerCase(),
            ...
            toggleClass: function(t, e) {
                ...
                : function() {
                    if ("string" === i)
                        ...
                        (i === _t || "boolean" === i) && (this.className && vt.set(this, "__className__", this.className),
                ...
                select: {
                    get: function(t) {
                        for (var e, i, n = t.options, s = t.selectedIndex, o = "select-one" === t.type || 0 > s, r = o ? null : [], a = o ? s + 1 : n.length, l = 0 > s ? a : o ? s : 0; a > l; l++)
                            if (i = n[l],
                            !(!i.selected && l !== s || (J.optDisabled ? i.disabled : null !== i.getAttribute("disabled")) || i.parentNode.disabled && Z.nodeName(i.parentNode, "optgroup"))) {
                                if (e = Z(i).val(),
                                o)
                                    return e;
                                r.push(e)
                    ...
                    set: function(t, e) {
                        for (var i, n, s = t.options, o = Z.makeArray(e), r = s.length; r--; )
                            n = s[r],
        ...
        Z.extend({
            ...
            ajax: function(t, e) {
                function i(t, e, i, r) {
                    ...
                    i && (y = U(u, x, i)),
                    y = P(u, y, x, l),
                    l ? (u.ifModified && (w = x.getResponseHeader("Last-Modified"),
                    w && (Z.lastModified[s] = w),
                    ...
                    x.status = t,
                    x.statusText = (e || T) + "",
                    l ? f.resolveWith(d, [c, T, x]) : f.rejectWith(d, [x, T, v]),
                    x.statusCode(m),
                    m = void 0,
                    h && p.trigger(l ? "ajaxSuccess" : "ajaxError", [x, u, l ? c : v]),
                    g.fireWith(d, [x, T]),
                    h && (p.trigger("ajaxComplete", [x, u]),
                    --Z.active || Z.event.trigger("ajaxStop")))
                }
                "object" == typeof t && (e = t,
                t = void 0),
                e = e || {};
                var n, s, o, r, a, l, h, c, u = Z.ajaxSetup({}, e), d = u.context || u, p = u.context && (d.nodeType || d.jquery) ? Z(d) : Z.event, f = Z.Deferred(), g = Z.Callbacks("once memory"), m = u.statusCode || {}, v = {}, y = {}, b = 0, w = "canceled", x = {
                    readyState: 0,
                ...
                if (f.promise(x).complete = g.add,
                x.success = x.done,
                x.error = x.fail,
                u.url = ((t || u.url || xe) + "").replace(ue, "").replace(me, Te[1] + "//"),
                ...
                Z.etag[s] && x.setRequestHeader("If-None-Match", Z.etag[s])),
                ...
                if (u.beforeSend && (u.beforeSend.call(d, x, u) === !1 || 2 === b))
                    return x.abort();
                w = "abort";
                for (c in {
                    success: 1,
        ...
        Z.fn.extend({
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var t = this.type;
                    return this.name && !Z(this).is(":disabled") && $e.test(this.nodeName) && !ke.test(t) && (this.checked || !Dt.test(t))
                }).map(function(t, e) {
                    var i = Z(this).val();
                ...
                send: function(i, n) {
                    ...
                    e = function(t) {
                        return function() {
                            ...
                            "abort" === t ? o.abort() : "error" === t ? n(o.status, o.statusText) : n(Ne[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
                                text: o.responseText
        ...
        Z.ajaxSetup({
            ...
            jsonpCallback: function() {
                var t = Me.pop() || Z.expando + "_" + he++;
                return this[t] = !0,
                t
            }
        }),
        Z.ajaxPrefilter("json jsonp", function(e, i, n) {
            var s, o, r, a = e.jsonp !== !1 && (je.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && je.test(e.data) && "data");
            return a || "jsonp" === e.dataTypes[0] ? (s = e.jsonpCallback = Z.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
            a ? e[a] = e[a].replace(je, "$1" + s) : e.jsonp !== !1 && (e.url += (ce.test(e.url) ? "&" : "?") + e.jsonp + "=" + s),
            e.converters["script json"] = function() {
                return r || Z.error(s + " was not called"),
                r[0]
            }
            ,
            e.dataTypes[0] = "json",
        ...
        Z.offset = {
            setOffset: function(t, e, i) {
                var n, s, o, r, a, l, h, c = Z.css(t, "position"), u = Z(t), d = {};
        ...
        Z.fn.extend({
            offset: function(t) {
                ...
                Z.contains(e, n) ? (typeof n.getBoundingClientRect !== _t && (s = n.getBoundingClientRect()),
                i = H(o),
                {
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (var t = this.offsetParent || Fe; t && !Z.nodeName(t, "html") && "static" === Z.css(t, "position"); )
                        t = t.offsetParent;
                    return t || Fe
                })
            }
        ...
        Z.each(["top", "left"], function(t, e) {
            Z.cssHooks[e] = T(J.pixelPosition, function(t, i) {
                return i ? (i = x(t, e),
                Wt.test(i) ? Z(t).position()[e] + "px" : i) : void 0
            })
        }),
        Z.each({
            Height: "height",
        ...
        return Z.noConflict = function(e) {
            return t.$ === Z && (t.$ = Le),
            e && t.jQuery === Z && (t.jQuery = Ie),
            Z
        }
        ,
        typeof e === _t && (t.jQuery = t.$ = Z),
        Z
    }),
    ...
    +function(t) {
        function i() {
            var t = e.createElement("bootstrap")
              , i = {
    ...
    +function(t) {
        ...
        ,
        t(e).on("click.bs.alert.data-api", n, s.prototype.close)
    }(jQuery),
    +function(t) {
        function i(e) {
            return this.each(function() {
                var i = t(this)
                  , s = i.data("bs.button")
                  , o = "object" == typeof e && e;
                s || i.data("bs.button", s = new n(this,o)),
        ...
        ,
        t(e).on("click.bs.button.data-api", '[data-toggle^="button"]', function(e) {
            var n = t(e.target);
    ...
    +function(i) {
        function n(t) {
            return this.each(function() {
                var e = i(this)
                  , n = e.data("bs.carousel")
                  , o = i.extend({}, s.DEFAULTS, e.data(), "object" == typeof t && t)
                  , r = "string" == typeof t ? t : o.slide;
                n || e.data("bs.carousel", n = new s(this,o)),
                "number" == typeof t ? n.to(t) : r ? n[r]() : o.interval && n.pause().cycle()
            })
        }
        var s = function(t, n) {
            this.$element = i(t),
            ...
            "hover" == this.options.pause && !("ontouchstart"in e.documentElement) && this.$element.on("mouseenter.bs.carousel", i.proxy(this.pause, this)).on("mouseleave.bs.carousel", i.proxy(this.cycle, this))
        };
        s.VERSION = "3.3.2",
        ...
        s.prototype.slide = function(t, e) {
            ...
            !c.isDefaultPrevented()) {
                ...
                this.$indicators.length) {
                    ...
                    var u = i(this.$indicators.children()[this.getItemIndex(o)]);
                    u && u.addClass("active")
                }
                var d = i.Event("slid.bs.carousel", {
                    relatedTarget: h,
                    direction: a
                });
                return i.support.transition && this.$element.hasClass("slide") ? (o.addClass(t),
                o[0].offsetWidth,
                n.addClass(a),
                o.addClass(a),
        ...
        i.fn.carousel.noConflict = function() {
            return i.fn.carousel = o,
            this
        }
        ;
        var r = function(t) {
            var e, s = i(this), o = i(s.attr("data-target") || (e = s.attr("href")) && e.replace(/.*(?=#[^\s]+$)/, ""));
            if (o.hasClass("carousel")) {
                var r = i.extend({}, o.data(), s.data())
        ...
        i(e).on("click.bs.carousel.data-api", "[data-slide]", r).on("click.bs.carousel.data-api", "[data-slide-to]", r),
    ...
    +function(t) {
        ...
        ,
        t(e).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function(e) {
            var s = t(this);
    ...
    +function(t) {
        function i(e) {
            ...
            t(r).each(function() {
                ...
                s.hasClass("open") && (s.trigger(e = t.Event("hide.bs.dropdown", o)),
        ...
        a.prototype.toggle = function(s) {
            ...
            if (!o.is(".disabled, :disabled")) {
                ...
                if (i(),
                !a) {
                    "ontouchstart"in e.documentElement && !r.closest(".navbar-nav").length && t('<div class="dropdown-backdrop"/>').insertAfter(t(this)).on("click", i);
                    var l = {
                        relatedTarget: this
                    };
                    if (r.trigger(s = t.Event("show.bs.dropdown", l)),
                    s.isDefaultPrevented())
                        return;
                    o.trigger("focus").attr("aria-expanded", "true"),
                    r.toggleClass("open").trigger("shown.bs.dropdown", l)
                }
                return !1
            }
        }
            ...
            if (/(38|40|27|32)/.test(e.which) && !/input|textarea/i.test(e.target.tagName)) {
                ...
                !i.is(".disabled, :disabled")) {
                    ...
                    if (!o && 27 != e.which || o && 27 == e.which)
                        return 27 == e.which && s.find(r).trigger("focus"),
                        i.trigger("click");
        ...
        ,
        t(e).on("click.bs.dropdown.data-api", i).on("click.bs.dropdown.data-api", ".dropdown form", function(t) {
            t.stopPropagation()
    ...
    +function(i) {
        function n(t, e) {
            return this.each(function() {
                var n = i(this)
                  , o = n.data("bs.modal")
                  , r = i.extend({}, s.DEFAULTS, n.data(), "object" == typeof t && t);
                o || n.data("bs.modal", o = new s(this,r)),
                "string" == typeof t ? o[t](e) : r.show && o.show(e)
            })
        }
        var s = function(t, n) {
            this.options = n,
        ...
        s.prototype.enforceFocus = function() {
            i(e).off("focusin.bs.modal").on("focusin.bs.modal", i.proxy(function(t) {
        ...
        s.prototype.resize = function() {
            this.isShown ? i(t).on("resize.bs.modal", i.proxy(this.handleUpdate, this)) : i(t).off("resize.bs.modal")
        }
        ,
        ...
        s.prototype.backdrop = function(t) {
            ...
            if (this.isShown && this.options.backdrop) {
                var o = i.support.transition && n;
                if (this.$backdrop = i('<div class="modal-backdrop ' + n + '" />').prependTo(this.$element).on("click.dismiss.bs.modal", i.proxy(function(t) {
        ...
        s.prototype.adjustDialog = function() {
            var t = this.$element[0].scrollHeight > e.documentElement.clientHeight;
            this.$element.css({
        ...
        s.prototype.checkScrollbar = function() {
            this.bodyIsOverflowing = e.body.scrollHeight > e.documentElement.clientHeight,
        ...
        ,
        i(e).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(t) {
            var e = i(this)
              , s = e.attr("href")
              , o = i(e.attr("data-target") || s && s.replace(/.*(?=#[^\s]+$)/, ""))
              , r = o.data("bs.modal") ? "toggle" : i.extend({
                remote: !/#/.test(s) && s
            }, o.data(), e.data());
    ...
    +function(i) {
        function n(t) {
            return this.each(function() {
                var e = i(this)
                  , n = e.data("bs.tooltip")
                  , o = "object" == typeof t && t;
                (n || "destroy" != t) && (n || e.data("bs.tooltip", n = new s(this,o)),
                "string" == typeof t && n[t]())
            })
        }
        var s = function(t, e) {
        ...
        s.prototype.init = function(t, e, n) {
            this.enabled = !0,
            this.type = t,
            this.$element = i(e),
            this.options = this.getOptions(n),
            this.$viewport = this.options.viewport && i(this.options.viewport.selector || this.options.viewport);
            for (var s = this.options.trigger.split(" "), o = s.length; o--; ) {
                ...
                if ("click" == r)
                    ...
                    this.$element.on(a + "." + this.type, this.options.selector, i.proxy(this.enter, this)),
                    this.$element.on(l + "." + this.type, this.options.selector, i.proxy(this.leave, this))
                }
            }
        ...
        s.prototype.getOptions = function(t) {
            return t = i.extend({}, this.getDefaults(), this.$element.data(), t),
        ...
        s.prototype.getDelegateOptions = function() {
            var t = {}
              , e = this.getDefaults();
            return this._options && i.each(this._options, function(i, n) {
                e[i] != n && (t[i] = n)
            }),
            t
        }
        ...
        ,
        s.prototype.show = function() {
            var t = i.Event("show.bs." + this.type);
            if (this.hasContent() && this.enabled) {
                this.$element.trigger(t);
                var e = i.contains(this.$element[0].ownerDocument.documentElement, this.$element[0]);
                ...
                if (h) {
                    var p = a
                      , f = this.options.container ? i(this.options.container) : this.$element.parent()
                      , g = this.getPosition(f);
                    a = "bottom" == a && c.bottom + d > g.bottom ? "top" : "top" == a && c.top - d < g.top ? "bottom" : "right" == a && c.right + u > g.width ? "left" : "left" == a && c.left - u < g.left ? "right" : a,
                ...
                i.support.transition && this.$tip.hasClass("fade") ? o.one("bsTransitionEnd", v).emulateTransitionEnd(s.TRANSITION_DURATION) : v()
            }
        }
        ,
        s.prototype.applyPlacement = function(t, e) {
            ...
            t.top = t.top + r,
            t.left = t.left + a,
            i.offset.setOffset(n[0], i.extend({
                using: function(t) {
                    n.css({
            ...
            var l = n[0].offsetWidth
              , h = n[0].offsetHeight;
            "top" == e && h != o && (t.top = t.top + o - h);
            var c = this.getViewportAdjustedDelta(e, t, l, h);
        ...
        s.prototype.hide = function(t) {
            ...
            i.support.transition && this.$tip.hasClass("fade") ? o.one("bsTransitionEnd", e).emulateTransitionEnd(s.TRANSITION_DURATION) : e(),
        ...
        ,
        s.prototype.getPosition = function(n) {
            n = n || this.$element;
            var s = n[0]
              , o = "BODY" == s.tagName
              , r = s.getBoundingClientRect();
            null == r.width && (r = i.extend({}, r, {
            ...
            var a = o ? {
              ...
              , l = {
                scroll: o ? e.documentElement.scrollTop || e.body.scrollTop : n.scrollTop()
            }
              , h = o ? {
                width: i(t).width(),
                height: i(t).height()
            } : null;
            return i.extend({}, r, l, h, a)
        }
        ,
        ...
        s.prototype.toggle = function(t) {
            var e = this;
            t && (e = i(t.currentTarget).data("bs." + this.type),
            e || (e = new this.constructor(t.currentTarget,this.getDelegateOptions()),
            i(t.currentTarget).data("bs." + this.type, e))),
        ...
        function e(e) {
            return this.each(function() {
                var n = t(this)
                  , s = n.data("bs.popover")
                  , o = "object" == typeof e && e;
                (s || "destroy" != e) && (s || n.data("bs.popover", s = new i(this,o)),
                "string" == typeof e && s[e]())
            })
        }
        var i = function(t, e) {
    ...
    +function(i) {
        function n(e, s) {
            var o = i.proxy(this.process, this);
            this.$body = i("body"),
            this.$scrollElement = i(i(e).is("body") ? t : e),
            this.options = i.extend({}, n.DEFAULTS, s),
        ...
        function s(t) {
            return this.each(function() {
                var e = i(this)
                  , s = e.data("bs.scrollspy")
                  , o = "object" == typeof t && t;
                s || e.data("bs.scrollspy", s = new n(this,o)),
                "string" == typeof t && s[t]()
            })
        }
        n.VERSION = "3.3.2",
        ...
        n.prototype.getScrollHeight = function() {
            return this.$scrollElement[0].scrollHeight || Math.max(this.$body[0].scrollHeight, e.documentElement.scrollHeight)
        }
        ,
        n.prototype.refresh = function() {
            ...
            this.$body.find(this.selector).map(function() {
                var n = i(this)
                  ...
                  , o = /^#./.test(s) && i(s);
                return o && o.length && o.is(":visible") && [[o[t]().top + e, s]] || null
            }).sort(function(t, e) {
                return t[0] - e[0]
            }).each(function() {
        ...
        ;
        var o = i.fn.scrollspy;
        i.fn.scrollspy = s,
        i.fn.scrollspy.Constructor = n,
        i.fn.scrollspy.noConflict = function() {
            return i.fn.scrollspy = o,
            this
        }
        ,
        i(t).on("load.bs.scrollspy.data-api", function() {
    ...
    +function(t) {
        ...
        n.prototype.activate = function(e, i, s) {
            ...
            r.length && a ? r.one("bsTransitionEnd", o).emulateTransitionEnd(n.TRANSITION_DURATION) : o(),
            r.removeClass("in")
        }
        ;
        var s = t.fn.tab;
        ...
        t(e).on("click.bs.tab.data-api", '[data-toggle="tab"]', o).on("click.bs.tab.data-api", '[data-toggle="pill"]', o)
    }(jQuery),
    +function(e) {
        function i(t) {
            return this.each(function() {
                var i = e(this)
                  , s = i.data("bs.affix")
                  , o = "object" == typeof t && t;
                s || i.data("bs.affix", s = new n(this,o)),
                "string" == typeof t && s[t]()
            })
        }
        var n = function(t, i) {
        ...
        n.prototype.getState = function(t, e, i, n) {
            ...
            if ("bottom" == this.affixed)
                return null != i ? !(s + this.unpin <= o.top) && "bottom" : !(t - n >= s + r) && "bottom";
    ...
    !function(t, e, i, n) {
        ...
        s.prototype.refresh = function() {
            return 0 !== this._items.length && ((new Date).getTime(),
        ...
        s.prototype.onDragMove = function(t) {
            ...
            this.drag.currentX = Math.max(Math.min(this.drag.currentX, a + h), l + h)),
        ...
        s.prototype.to = function(i, n) {
            if (this.settings.loop) {
                ...
                a < this.settings.items && l === !1 ? (o = r + this._items.length,
                this.reset(o)) : a >= h - this.settings.items && l === !0 && (o = r - this._items.length,
                this.reset(o)),
    ...
    function(t, e, i) {
        ...
        n.prototype.fetch = function(t, e) {
            ...
            if (n = r.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/),
            n[3].indexOf("youtu") > -1)
                i = "youtube";
            else {
        ...
        n.prototype.thumbnail = function(e, i) {
            var n, s, o, r = i.width && i.height ? 'style="width:' + i.width + "px;height:" + i.height + 'px;"' : "", a = e.find("img"), l = "src", h = "", c = this._core.settings, u = function(t) {
        ...
        n.prototype.isInFullScreen = function() {
            ...
            this._fullscreen = !0),
            !(n && this._fullscreen && this._playing) && (this._fullscreen ? (this._fullscreen = !1,
    ...
    function(e) {
        ...
        s.prototype = {
            ...
            placeholder: function(t) {
                return t === i ? this.options.placeholder : (this.options.placeholder = t,
                void this.$elementFilestyle.find("input").attr("placeholder", t))
            },
            buttonText: function(t) {
                return t === i ? this.options.buttonText : (this.options.buttonText = t,
                void this.$elementFilestyle.find("label .buttonText").html(this.options.buttonText))
            },
            buttonName: function(t) {
                return t === i ? this.options.buttonName : (this.options.buttonName = t,
                void this.$elementFilestyle.find("label").attr({
                    "class": "btn " + this.options.buttonName
                }))
            },
            iconName: function(t) {
                return t === i ? this.options.iconName : void this.$elementFilestyle.find(".icon-span-filestyle").attr({
                    "class": "icon-span-filestyle " + this.options.iconName
                })
            },
            htmlIcon: function() {
                return this.options.icon ? '<i class="icon-span-filestyle ' + this.options.iconName + '"></i> ' : ""
            },
            htmlInput: function() {
            ...
            constructor: function() {
                ...
                s = i.options.buttonBefore ? r + i.htmlInput() : i.htmlInput() + r,
                i.$elementFilestyle = e('<div class="bootstrap-filestyle input-group">' + s + "</div>"),
                ...
                t.navigator.userAgent.search(/firefox/i) > -1 && i.$elementFilestyle.find("label").click(function() {
            ...
            var o = ""
              , r = this.each(function() {
                if ("file" === e(this).attr("type")) {
                    ...
                    r || (i.data("filestyle", r = new s(this,a)),
                    r.constructor()),
                    "string" == typeof t && (o = r[t](n))
                }
            });
            return typeof o !== i ? o : r
        }
        ,
        e.fn.filestyle.defaults = {
            buttonText: "",
            iconName: "fa fa-paperclip",
            buttonName: "Button-main",
            size: "nr",
            input: !0,
            badge: !0,
            icon: !0,
    ...
    !function(t) {
        ...
        function h(t, e) {
            ...
            var s, o = i(t).data(), r = {}, a = new RegExp("^" + e.toLowerCase() + "([A-Z])");
            e = new RegExp("^" + e.toLowerCase());
            for (var l in o)
                e.test(l) && (s = l.replace(a, n),
                r[s] = o[l]);
            return r
        }
        function c(t) {
        ...
        d.prototype = {
            ...
            _resolveViewName: function(t, e) {
                return 0 === t || "days" === t || "month" === t ? 0 : 1 === t || "months" === t || "year" === t ? 1 : 2 === t || "years" === t || "decade" === t ? 2 : 3 === t || "decades" === t || "century" === t ? 3 : 4 === t || "centuries" === t || "millennium" === t ? 4 : e !== n && e
            },
            ...
            _process_options: function(t) {
                this._o = i.extend({}, this._o, t);
                var e = this.o = i.extend({}, this._o)
                  , n = e.language;
                y[n] || (n = n.split("-")[0],
                y[n] || (n = m.language)),
                e.language = n,
                ...
                var r = b.parseFormat(e.format);
                e.startDate !== -(1 / 0) && (e.startDate ? e.startDate instanceof Date ? e.startDate = this._local_to_utc(this._zero_time(e.startDate)) : e.startDate = b.parseDate(e.startDate, r, e.language, e.assumeNearbyYear) : e.startDate = -(1 / 0)),
                e.endDate !== 1 / 0 && (e.endDate ? e.endDate instanceof Date ? e.endDate = this._local_to_utc(this._zero_time(e.endDate)) : e.endDate = b.parseDate(e.endDate, r, e.language, e.assumeNearbyYear) : e.endDate = 1 / 0),
                e.daysOfWeekDisabled = e.daysOfWeekDisabled || [],
                i.isArray(e.daysOfWeekDisabled) || (e.daysOfWeekDisabled = e.daysOfWeekDisabled.split(/[,\s]*/)),
                e.daysOfWeekDisabled = i.map(e.daysOfWeekDisabled, function(t) {
                    return parseInt(t, 10)
                }),
                e.daysOfWeekHighlighted = e.daysOfWeekHighlighted || [],
                i.isArray(e.daysOfWeekHighlighted) || (e.daysOfWeekHighlighted = e.daysOfWeekHighlighted.split(/[,\s]*/)),
                e.daysOfWeekHighlighted = i.map(e.daysOfWeekHighlighted, function(t) {
                    return parseInt(t, 10)
                }),
                e.datesDisabled = e.datesDisabled || [],
                i.isArray(e.datesDisabled) || (e.datesDisabled = [e.datesDisabled]),
                e.datesDisabled = i.map(e.datesDisabled, function(t) {
                    return b.parseDate(t, r, e.language, e.assumeNearbyYear)
                });
                var a = String(e.orientation).toLowerCase().split(/\s+/g)
                  , l = e.orientation.toLowerCase();
                if (a = i.grep(a, function(t) {
                ...
                if (e.defaultViewDate) {
                    var h = e.defaultViewDate.year || (new Date).getFullYear()
                      , c = e.defaultViewDate.month || 0
                      , u = e.defaultViewDate.day || 1;
                    e.defaultViewDate = s(h, c, u)
                } else
                    e.defaultViewDate = o()
            },
            _events: [],
            ...
            _unapplyEvents: function(t) {
                for (var e, i, s, o = 0; o < t.length; o++)
                    e = t[o][0],
                    2 === t[o].length ? (s = n,
                    i = t[o][1]) : 3 === t[o].length && (s = t[o][1],
                    i = t[o][2]),
                    e.off(i, s)
            },
            _buildEvents: function() {
                var n = {
                    keyup: i.proxy(function(t) {
                        -1 === i.inArray(t.keyCode, [27, 37, 39, 38, 40, 32, 13, 9]) && this.update()
                    }, this),
                    keydown: i.proxy(this.keydown, this),
                    paste: i.proxy(this.paste, this)
                };
                this.o.showOnFocus === !0 && (n.focus = i.proxy(this.show, this)),
                this.isInput ? this._events = [[this.element, n]] : this.component && this.hasInput ? this._events = [[this.inputField, n], [this.component, {
                ...
                this.o.immediateUpdates && this._events.push([this.element, {
                    "changeYear changeMonth": i.proxy(function(t) {
                        this.update(t.date)
                    }, this)
                }]),
            ...
            show: function() {
                ...
                this._trigger("show"),
                (t.navigator.msMaxTouchPoints || "ontouchstart"in e) && this.o.disableTouchKeyboard && i(this.element).blur(),
                this)
            },
            hide: function() {
            ...
            paste: function(e) {
                var n;
                if (e.originalEvent.clipboardData && e.originalEvent.clipboardData.types && -1 !== i.inArray("text/plain", e.originalEvent.clipboardData.types))
            ...
            getUTCDates: function() {
                return i.map(this.dates, function(t) {
                    return new Date(t)
                })
            },
            getDate: function() {
            ...
            setDates: function() {
                var t = i.isArray(arguments[0]) ? arguments[0] : arguments;
            ...
            setUTCDates: function() {
                var t = i.isArray(arguments[0]) ? arguments[0] : arguments;
                return this.update.apply(this, i.map(t, this._utc_to_local)),
                this._trigger("changeDate"),
                this.setValue(),
                this
            },
            ...
            getFormattedDate: function(t) {
                ...
                return i.map(this.dates, function(i) {
                    return b.formatDate(i, t, e)
            ...
            place: function() {
                ...
                var t = this.picker.outerWidth()
                  ...
                  , s = 10
                  , o = i(this.o.container)
                  , r = o.width()
                  , a = "body" === this.o.container ? i(e).scrollTop() : o.scrollTop()
                  , l = o.offset()
                  , h = [];
                this.element.parents().each(function() {
                    var t = i(this).css("z-index");
                    "auto" !== t && 0 !== t && h.push(parseInt(t))
                });
                var c = Math.max.apply(Math, h) + this.o.zIndexOffset
                  ...
                  , f = u.left - l.left
                  , g = u.top - l.top;
                "body" !== this.o.container && (g += a),
                this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left"),
                "auto" !== this.o.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.o.orientation.x),
                "right" === this.o.orientation.x && (f -= t - p)) : u.left < 0 ? (this.picker.addClass("datepicker-orient-left"),
                f -= u.left - s) : f + t > r ? (this.picker.addClass("datepicker-orient-right"),
                f += p - t) : this.picker.addClass("datepicker-orient-left");
                var m, v = this.o.orientation.y;
                if ("auto" === v && (m = -a + g - n,
                v = 0 > m ? "bottom" : "top"),
                this.picker.addClass("datepicker-orient-" + v),
                "top" === v ? g -= n + parseInt(this.picker.css("padding-top")) : g += d,
                this.o.rtl) {
                    var y = r - (f + p);
                    this.picker.css({
                        top: g,
            ...
            update: function() {
                ...
                var t = this.dates.copy()
                  , e = []
                  , n = !1;
                return arguments.length ? (i.each(arguments, i.proxy(function(t, i) {
                    i instanceof Date && (i = this._local_to_utc(i)),
                    e.push(i)
                }, this)),
                n = !0) : (e = this.isInput ? this.element.val() : this.element.data("date") || this.inputField.val(),
                e = e && this.o.multidate ? e.split(this.o.multidateSeparator) : [e],
                delete this.element.data().date),
                e = i.map(e, i.proxy(function(t) {
                    return b.parseDate(t, this.o.format, this.o.language, this.o.assumeNearbyYear)
                }, this)),
                e = i.grep(e, i.proxy(function(t) {
                ...
                n ? this.setValue() : e.length && String(t) !== String(this.dates) && this._trigger("changeDate"),
            ...
            fillDow: function() {
                ...
                e += '<th class="cw">&#160;</th>'); t < this.o.weekStart + 7; )
                    e += '<th class="dow',
                    i.inArray(t, this.o.daysOfWeekDisabled) > -1 && (e += " disabled"),
                    e += '">' + y[this.o.language].daysMin[t++ % 7] + "</th>";
                e += "</tr>",
            ...
            fillMonths: function() {
                for (var t = this._utc_to_local(this.viewDate), e = "", i = 0; 12 > i; ) {
                    ...
                    e += '<span class="month' + n + '">' + y[this.o.language].monthsShort[i++] + "</span>"
                }
                this.picker.find(".datepicker-months td").html(e)
            },
            setRange: function(t) {
                t && t.length ? this.range = i.map(t, function(t) {
                    return t.valueOf()
                }) : delete this.range,
                this.fill()
            },
            getClassNames: function(t) {
                var e = []
                  ...
                  , o = new Date;
                return t.getUTCFullYear() < n || t.getUTCFullYear() === n && t.getUTCMonth() < s ? e.push("old") : (t.getUTCFullYear() > n || t.getUTCFullYear() === n && t.getUTCMonth() > s) && e.push("new"),
                this.focusDate && t.valueOf() === this.focusDate.valueOf() && e.push("focused"),
                this.o.todayHighlight && t.getUTCFullYear() === o.getFullYear() && t.getUTCMonth() === o.getMonth() && t.getUTCDate() === o.getDate() && e.push("today"),
                ...
                -1 !== i.inArray(t.getUTCDay(), this.o.daysOfWeekHighlighted) && e.push("highlighted"),
                this.range && (t > this.range[0] && t < this.range[this.range.length - 1] && e.push("range"),
                -1 !== i.inArray(t.valueOf(), this.range) && e.push("selected"),
                t.valueOf() === this.range[0] && e.push("range-start"),
                t.valueOf() === this.range[this.range.length - 1] && e.push("range-end")),
                e
            },
            _fill_yearsView: function(t, e, s, o, r, a, l, h) {
                var c, u, d, p, f, g, m, v, y, b, w;
                for (c = "",
                u = this.picker.find(t),
                d = parseInt(r / s, 10) * s,
                f = parseInt(a / o, 10) * o,
                g = parseInt(l / o, 10) * o,
                p = i.map(this.dates, function(t) {
                    return parseInt(t.getUTCFullYear() / o, 10) * o
                }),
                u.find(".datepicker-switch").text(d + "-" + (d + 9 * o)),
                m = d - o,
                v = -1; 11 > v; v += 1)
                    y = [e],
                    b = null,
                    -1 === v ? y.push("old") : 10 === v && y.push("new"),
                    -1 !== i.inArray(m, p) && y.push("active"),
                    (f > m || m > g) && y.push("disabled"),
                    m === this.viewDate.getFullYear() && y.push("focused"),
                    h !== i.noop && (w = h(new Date(m,0,1)),
                    w === n ? w = {} : "boolean" == typeof w ? w = {
                        enabled: w
                    } : "string" == typeof w && (w = {
                        classes: w
                    }),
            ...
            fill: function() {
                var t, e, o = new Date(this.viewDate), r = o.getUTCFullYear(), a = o.getUTCMonth(), l = this.o.startDate !== -(1 / 0) ? this.o.startDate.getUTCFullYear() : -(1 / 0), h = this.o.startDate !== -(1 / 0) ? this.o.startDate.getUTCMonth() : -(1 / 0), c = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCFullYear() : 1 / 0, u = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCMonth() : 1 / 0, d = y[this.o.language].today || y.en.today || "", p = y[this.o.language].clear || y.en.clear || "", f = y[this.o.language].titleFormat || y.en.titleFormat;
                if (!isNaN(r) && !isNaN(a)) {
                    this.picker.find(".datepicker-days .datepicker-switch").text(b.formatDate(o, f, this.o.language)),
                    ...
                    this.fillMonths();
                    var g = s(r, a - 1, 28)
                      , m = b.getDaysInMonth(g.getUTCFullYear(), g.getUTCMonth());
                    g.setUTCDate(m),
                    ...
                    for (var w, x = []; g.valueOf() < v; ) {
                        ...
                        this.o.calendarWeeks)) {
                            var T = new Date(+g + (this.o.weekStart - g.getUTCDay() - 7) % 7 * 864e5)
                              ...
                              , D = new Date(Number(D = s(C.getUTCFullYear(), 0, 1)) + (11 - D.getUTCDay()) % 7 * 864e5)
                              , _ = (C - D) / 864e5 / 7 + 1;
                            x.push('<td class="cw">' + _ + "</td>")
                        }
                        w = this.getClassNames(g),
                        w.push("day"),
                        this.o.beforeShowDay !== i.noop && (e = this.o.beforeShowDay(this._utc_to_local(g)),
                        e === n ? e = {} : "boolean" == typeof e ? e = {
                            enabled: e
                        } : "string" == typeof e && (e = {
                            classes: e
                        }),
                        e.enabled === !1 && w.push("disabled"),
                        e.classes && (w = w.concat(e.classes.split(/\s+/))),
                        e.tooltip && (t = e.tooltip)),
                        w = i.isFunction(i.uniqueSort) ? i.uniqueSort(w) : i.unique(w),
                        x.push('<td class="' + w.join(" ") + '"' + (t ? ' title="' + t + '"' : "") + ">" + g.getUTCDate() + "</td>"),
                        t = null,
                    ...
                    var k = y[this.o.language].monthsTitle || y.en.monthsTitle || "Months"
                      , $ = this.picker.find(".datepicker-months").find(".datepicker-switch").text(this.o.maxViewMode < 2 ? k : r).end().find("span").removeClass("active");
                    if (i.each(this.dates, function(t, e) {
                        e.getUTCFullYear() === r && $.eq(e.getUTCMonth()).addClass("active")
                    }),
                    (l > r || r > c) && $.addClass("disabled"),
                    r === l && $.slice(0, h).addClass("disabled"),
                    r === c && $.slice(u + 1).addClass("disabled"),
                    this.o.beforeShowMonth !== i.noop) {
                        var E = this;
                        i.each($, function(t, e) {
                            var s = new Date(r,t,1)
                              , o = E.o.beforeShowMonth(s);
                            o === n ? o = {} : "boolean" == typeof o ? o = {
                                enabled: o
                            } : "string" == typeof o && (o = {
                                classes: o
                            }),
                            o.enabled !== !1 || i(e).hasClass("disabled") || i(e).addClass("disabled"),
                            o.classes && i(e).addClass(o.classes),
                            o.tooltip && i(e).prop("title", o.tooltip)
                        })
                    }
            ...
            click: function(t) {
                ...
                var u = e.closest(".prev, .next");
                u.length > 0 && (n = b.modes[this.viewMode].navStep * (u.hasClass("prev") ? -1 : 1),
            ...
            moveMonth: function(t, e) {
                ...
                if (!e)
                    return t;
                var i, n, s = new Date(t.valueOf()), o = s.getUTCDate(), r = s.getUTCMonth(), a = Math.abs(e);
                if (e = e > 0 ? 1 : -1,
                1 === a)
                    n = -1 === e ? function() {
            ...
            weekOfDateIsDisabled: function(t) {
                return -1 !== i.inArray(t.getUTCDay(), this.o.daysOfWeekDisabled)
            },
            dateIsDisabled: function(t) {
                return this.weekOfDateIsDisabled(t) || i.grep(this.o.datesDisabled, function(e) {
                    return r(t, e)
                }).length > 0
            },
            ...
            keydown: function(t) {
                ...
                case 40:
                    ...
                    0 === this.viewMode ? t.ctrlKey ? (i = this.moveAvailableDate(s, e, "moveYear"),
                    i && this._trigger("changeYear", this.viewDate)) : t.shiftKey ? (i = this.moveAvailableDate(s, e, "moveMonth"),
                    i && this._trigger("changeMonth", this.viewDate)) : 37 === t.keyCode || 39 === t.keyCode ? i = this.moveAvailableDate(s, e, "moveDay") : this.weekOfDateIsDisabled(s) || (i = this.moveAvailableDate(s, e, "moveWeek")) : 1 === this.viewMode ? ((38 === t.keyCode || 40 === t.keyCode) && (e = 4 * e),
                    i = this.moveAvailableDate(s, e, "moveMonth")) : 2 === this.viewMode && ((38 === t.keyCode || 40 === t.keyCode) && (e = 4 * e),
        ...
        var p = function(t, e) {
            i(t).data("datepicker", this),
            this.element = i(t),
            this.inputs = i.map(e.inputs, function(t) {
                return t.jquery ? t[0] : t
            }),
            delete e.inputs,
            g.call(i(this.inputs), e).on("changeDate", i.proxy(this.dateUpdated, this)),
            this.pickers = i.map(this.inputs, function(t) {
                return i(t).data("datepicker")
            }),
            this.updateDates()
        };
        p.prototype = {
            updateDates: function() {
                this.dates = i.map(this.pickers, function(t) {
                    return t.getUTCDate()
                }),
                this.updateRanges()
            },
            updateRanges: function() {
                var t = i.map(this.dates, function(t) {
                    return t.valueOf()
                });
                i.each(this.pickers, function(e, i) {
                    i.setRange(t)
                })
            },
            dateUpdated: function(t) {
                if (!this.updating) {
                    this.updating = !0;
                    var e = i(t.target).data("datepicker");
                    if ("undefined" != typeof e) {
                        var n = e.getUTCDate()
                          , s = i.inArray(t.target, this.inputs)
                          , o = s - 1
                          , r = s + 1
                          , a = this.inputs.length;
                        if (-1 !== s) {
                            if (i.each(this.pickers, function(t, e) {
            ...
            remove: function() {
                i.map(this.pickers, function(t) {
                    t.remove()
                }),
                delete this.element.data().datepicker
            }
        };
        var f = i.fn.datepicker
          , g = function(t) {
            ...
            if (this.each(function() {
                ...
                if (!o) {
                    var a = h(this, "date")
                      ...
                      , u = c(l.language)
                      , f = i.extend({}, m, u, a, r);
                    n.hasClass("input-daterange") || f.inputs ? (i.extend(f, {
                        inputs: f.inputs || n.find("input").toArray()
                    }),
                    o = new p(this,f)) : o = new d(this,f),
                    n.data("datepicker", o)
                }
                "string" == typeof t && "function" == typeof o[t] && (s = o[t].apply(o, e))
            }),
            s === n || s instanceof d || s instanceof p)
                return this;
            if (this.length > 1)
                throw new Error("Using only allowed for the collection of a single element (" + t + " function)");
            return s
        };
        i.fn.datepicker = g;
        var m = i.fn.datepicker.defaults = {
            assumeNearbyYear: !1,
            autoclose: !1,
          ...
          , v = i.fn.datepicker.locale_opts = ["format", "rtl", "weekStart"];
        i.fn.datepicker.Constructor = d;
        var y = i.fn.datepicker.dates = {
            en: {
          ...
          , b = {
            ...
            getDaysInMonth: function(t, e) {
                return [31, b.isLeapYear(t) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e]
            },
            ...
            parseDate: function(t, e, r, a) {
                ...
                function h() {
                    var t = this.slice(0, m[p].length)
                      , e = m[p].slice(0, t.length);
                ...
                if (t instanceof Date)
                    return t;
                if ("string" == typeof e && (e = b.parseFormat(e)),
                e.toValue)
                    return e.toValue(t, e, r);
                var c, u, p, f, g = /([\-+]\d+)([dmwy])/, m = t.match(/([\-+]\d+)([dmwy])/g), v = {
                    d: "moveDay",
                    m: "moveMonth",
                    w: "moveWeek",
                    y: "moveYear"
                ...
                m = t && t.match(this.nonpunctuation) || [],
                t = new Date;
                var x, T, C = {}, D = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], _ = {
                    yyyy: function(t, e) {
                ...
                t = o();
                var k = e.parts.slice();
                if (m.length !== k.length && (k = i(k).filter(function(t, e) {
                    return -1 !== i.inArray(e, D)
                }).toArray()),
                m.length === k.length) {
                    var $;
                    for (p = 0,
                    $ = k.length; $ > p; p++) {
                        if (x = parseInt(m[p], 10),
                        c = k[p],
                        isNaN(x))
                            switch (c) {
                            case "MM":
                                T = i(y[r].months).filter(h),
                                x = i.inArray(T[0], y[r].months) + 1;
                                break;
                            case "M":
                                T = i(y[r].monthsShort).filter(h),
                                x = i.inArray(T[0], y[r].monthsShort) + 1
                            }
                        C[c] = x
                    }
                    var E, S;
            ...
            formatDate: function(t, e, n) {
                ...
                if ("string" == typeof e && (e = b.parseFormat(e)),
                e.toDisplay)
                    return e.toDisplay(t, e, n);
                var s = {
                    d: t.getUTCDate(),
                    D: y[n].daysShort[t.getUTCDay()],
                    DD: y[n].days[t.getUTCDay()],
                    m: t.getUTCMonth() + 1,
                    M: y[n].monthsShort[t.getUTCMonth()],
                    MM: y[n].months[t.getUTCMonth()],
                ...
                s.mm = (s.m < 10 ? "0" : "") + s.m,
                t = [];
                for (var o = i.extend([], e.separators), r = 0, a = e.parts.length; a >= r; r++)
        ...
        i.fn.datepicker.DPGlobal = b,
        i.fn.datepicker.noConflict = function() {
            return i.fn.datepicker = f,
            this
        }
        ,
        i.fn.datepicker.version = "1.6.4",
        i(e).on("focus.datepicker.data-api click.datepicker.data-api", '[data-provide="datepicker"]', function(t) {
            var e = i(this);
            e.data("datepicker") || (t.preventDefault(),
            g.call(e, "show"))
        }),
        i(function() {
            g.call(i('[data-provide="datepicker-inline"]'))
        })
    }),
    !function(t) {
        t.fn.datepicker.dates.es = {
    ...
    !function(e) {
        "function" == typeof define && define.amd ? define(["jquery"], e) : e("undefined" != typeof jQuery ? jQuery : t.Zepto)
    }(function(i) {
        function n(t) {
            var e = t.data;
            t.isDefaultPrevented() || (t.preventDefault(),
            i(t.target).ajaxSubmit(e))
        }
        function s(t) {
            var e = t.target
              , n = i(e);
        ...
        function o() {
            if (i.fn.ajaxSubmit.debug) {
                ...
                t.console && t.console.log ? t.console.log(e) : t.opera && t.opera.postError && t.opera.postError(e)
            }
        }
        var r = {};
        r.fileapi = void 0 !== i("<input type='file'/>").get(0).files,
        r.formdata = void 0 !== t.FormData;
        var a = !!i.fn.prop;
        i.fn.attr2 = function() {
            if (!a)
        ...
        ,
        i.fn.ajaxSubmit = function(n) {
            function s(t) {
                var e, s, o = i.param(t, n.traditional).split("&"), r = o.length, a = [];
                for (e = 0; r > e; e++)
                    o[e] = o[e].replace(/\+/g, " "),
                    s = o[e].split("="),
            ...
            function l(t) {
                for (var e = new FormData, o = 0; o < t.length; o++)
                    e.append(t[o].name, t[o].value);
                if (n.extraData) {
                    var r = s(n.extraData);
                    for (o = 0; o < r.length; o++)
                        r[o] && e.append(r[o][0], r[o][1])
                }
                n.data = null;
                var a = i.extend(!0, {}, i.ajaxSettings, n, {
                    contentType: !1,
                    processData: !1,
                    cache: !1,
                    type: c || "POST"
                ...
                return a.beforeSend = function(t, i) {
                    i.data = n.formData ? n.formData : e,
                    l && l.call(this, t, i)
                }
                ,
                i.ajax(a)
            ...
            function h(s) {
                ...
                function l() {
                    function t() {
                        try {
                            var e = r(b).readyState;
                            o("state = " + e),
                            e && "uninitialized" == e.toLowerCase() && setTimeout(t, 50)
                        } catch (i) {
                            o("Server abort: ", i, " (", i.name, ")"),
                            h(E),
                            D && clearTimeout(D),
                            D = void 0
                        }
                    ...
                    var n = p.attr2("target")
                      ...
                      , l = p.attr("enctype") || p.attr("encoding") || a;
                    _.setAttribute("target", m),
                    (!c || /post/i.test(c)) && _.setAttribute("method", "POST"),
                    s != f.url && _.setAttribute("action", f.url),
                    f.skipEncodingOverride || c && !/post/i.test(c) || p.attr({
                    ...
                    try {
                        if (f.extraData)
                            for (var d in f.extraData)
                                f.extraData.hasOwnProperty(d) && u.push(i.isPlainObject(f.extraData[d]) && f.extraData[d].hasOwnProperty("name") && f.extraData[d].hasOwnProperty("value") ? i('<input type="hidden" name="' + f.extraData[d].name + '">').val(f.extraData[d].value).appendTo(_)[0] : i('<input type="hidden" name="' + d + '">').val(f.extraData[d]).appendTo(_)[0]);
                        f.iframeTarget || y.appendTo("body"),
                        b.attachEvent ? b.attachEvent("onload", h) : b.addEventListener("load", h, !1),
                        setTimeout(t, 15);
                        try {
                            _.submit()
                        } catch (g) {
                            var v = e.createElement("form").submit;
                            v.apply(_)
                        }
                    } finally {
                        _.setAttribute("action", s),
                        _.setAttribute("enctype", l),
                ...
                function h(e) {
                    if (!w.aborted && !j) {
                        if (M = r(b),
                        M || (o("cannot access response document"),
                        e = E),
                        e === $ && w)
                            return w.abort("timeout"),
                            void k.reject(w, "timeout");
                        if (e == E && w)
                            return w.abort("server abort"),
                            void k.reject(w, "error", "server abort");
                        if (M && M.location.href != f.iframeSrc || C) {
                            b.detachEvent ? b.detachEvent("onload", h) : b.removeEventListener("load", h, !1);
                            var n, s = "success";
                            try {
                                if (C)
                                    throw "timeout";
                                var a = "xml" == f.dataType || M.XMLDocument || i.isXMLDoc(M);
                                if (o("isXml=" + a),
                                !a && t.opera && (null === M.body || !M.body.innerHTML) && --O)
                                ...
                                w.responseXML = M.XMLDocument ? M.XMLDocument : M,
                                a && (f.dataType = "xml"),
                                ...
                                ,
                                l && (w.status = Number(l.getAttribute("status")) || w.status,
                                w.statusText = l.getAttribute("statusText") || w.statusText);
                                var c = (f.dataType || "").toLowerCase()
                                  , u = /(json|script|text)/.test(c);
                                if (u || f.textarea) {
                                    var d = M.getElementsByTagName("textarea")[0];
                                    if (d)
                                        w.responseText = d.value,
                                        w.status = Number(d.getAttribute("status")) || w.status,
                                        w.statusText = d.getAttribute("statusText") || w.statusText;
                                    else if (u) {
                                    ...
                                    "xml" == c && !w.responseXML && w.responseText && (w.responseXML = F(w.responseText));
                                try {
                                    A = L(w, c, f)
                                } catch (v) {
                                    s = "parsererror",
                            ...
                            w.aborted && (o("upload aborted"),
                            s = null),
                            w.status && (s = w.status >= 200 && w.status < 300 || 304 === w.status ? "success" : "error"),
                            "success" === s ? (f.success && f.success.call(f.context, A, "success", w),
                            k.resolve(w.responseText, "success", w),
                            g && i.event.trigger("ajaxSuccess", [w, f])) : s && (void 0 === n && (n = w.statusText),
                            f.error && f.error.call(f.context, w, s, n),
                            k.reject(w, "error", n),
                            g && i.event.trigger("ajaxError", [w, f, n])),
                            g && i.event.trigger("ajaxComplete", [w, f]),
                            g && !--i.active && i.event.trigger("ajaxStop"),
                            f.complete && f.complete.call(f.context, w, s),
                            j = !0,
                ...
                var u, d, f, g, m, y, b, w, x, T, C, D, _ = p[0], k = i.Deferred();
                ...
                s)
                    for (d = 0; d < v.length; d++)
                        u = i(v[d]),
                        a ? u.prop("disabled", !1) : u.removeAttr("disabled");
                if (f = i.extend(!0, {}, i.ajaxSettings, n),
                f.context = f.context || f,
                m = "jqFormIO" + (new Date).getTime(),
                f.iframeTarget ? (y = i(f.iframeTarget),
                T = y.attr2("name"),
                T ? m = T : y.attr2("name", m)) : (y = i('<iframe name="' + m + '" src="' + f.iframeSrc + '" />'),
                y.css({
                    position: "absolute",
                    top: "-1000px",
                    left: "-1000px"
                ...
                w = {
                    ...
                    abort: function(t) {
                        ...
                        w.error = e,
                        f.error && f.error.call(f.context, w, e, t),
                        g && i.event.trigger("ajaxError", [w, f, e]),
                        f.complete && f.complete.call(f.context, w, e)
                    }
                },
                g = f.global,
                g && 0 === i.active++ && i.event.trigger("ajaxStart"),
                g && i.event.trigger("ajaxSend", [w, f]),
                f.beforeSend && f.beforeSend.call(f.context, w, f) === !1)
                    return f.global && i.active--,
                    k.reject(),
                    k;
                if (w.aborted)
                    return k.reject(),
                ...
                x = _.clk,
                x && (T = x.name,
                T && !x.disabled && (f.extraData = f.extraData || {},
                f.extraData[T] = x.value,
                "image" == x.type && (f.extraData[T + ".x"] = _.clk_x,
                f.extraData[T + ".y"] = _.clk_y)));
                var $ = 1
                  , E = 2
                  , S = i("meta[name=csrf-token]").attr("content")
                  , N = i("meta[name=csrf-param]").attr("content");
                N && S && (f.extraData = f.extraData || {},
                f.extraData[N] = S),
                f.forceSync ? l() : setTimeout(l, 10);
                var A, M, j, O = 50, F = i.parseXML || function(e, i) {
                    return t.ActiveXObject ? (i = new ActiveXObject("Microsoft.XMLDOM"),
                    i.async = "false",
                    i.loadXML(e)) : i = (new DOMParser).parseFromString(e, "text/xml"),
                ...
                , L = function(t, e, n) {
                    var s = t.getResponseHeader("content-type") || ""
                      , o = "xml" === e || !e && s.indexOf("xml") >= 0
                      , r = o ? t.responseXML : t.responseText;
                    return o && "parsererror" === r.documentElement.nodeName && i.error && i.error("parsererror"),
                    n && n.dataFilter && (r = n.dataFilter(r, e)),
                    "string" == typeof r && ("json" === e || !e && s.indexOf("json") >= 0 ? r = I(r) : ("script" === e || !e && s.indexOf("javascript") >= 0) && i.globalEval(r)),
                    r
                };
                return k
            }
            ...
            c = n.type || this.attr2("method"),
            u = n.url || this.attr2("action"),
            d = "string" == typeof u ? i.trim(u) : "",
            d = d || t.location.href || "",
            d && (d = (d.match(/^([^#]+)/) || [])[1]),
            n = i.extend(!0, {
                url: d,
                success: i.ajaxSettings.success,
                type: c || i.ajaxSettings.type,
                iframeSrc: /^https/i.test(t.location.href || "") ? "javascript:false" : "about:blank"
            }, n);
            var f = {};
            if (this.trigger("form-pre-serialize", [this, n, f]),
            f.veto)
            ...
            if (n.beforeSerialize && n.beforeSerialize(this, n) === !1)
                ...
                this;
            var g = n.traditional;
            void 0 === g && (g = i.ajaxSettings.traditional);
            var m, v = [], y = this.formToArray(n.semantic, v);
            if (n.data && (n.extraData = n.data,
            m = i.param(n.data, g)),
            n.beforeSubmit && n.beforeSubmit(y, this, n) === !1)
                return o("ajaxSubmit: submit aborted via beforeSubmit callback"),
                this;
            if (this.trigger("form-submit-validate", [y, this, n, f]),
            f.veto)
                return o("ajaxSubmit: submit vetoed via form-submit-validate trigger"),
                this;
            var b = i.param(y, g);
            m && (b = b ? b + "&" + m : m),
            "GET" == n.type.toUpperCase() ? (n.url += (n.url.indexOf("?") >= 0 ? "&" : "?") + b,
            n.data = null) : n.data = b;
            var w = [];
            if (n.resetForm && w.push(function() {
                p.resetForm()
            }),
            n.clearForm && w.push(function() {
                p.clearForm(n.includeHidden)
            }),
            !n.dataType && n.target) {
                var x = n.success || function() {}
                ;
                w.push(function(t) {
                    var e = n.replaceTarget ? "replaceWith" : "html";
                    i(n.target)[e](t).each(x, arguments)
                })
            } else
                n.success && w.push(n.success);
            if (n.success = function(t, e, i) {
                for (var s = n.context || this, o = 0, r = w.length; r > o; o++)
                    w[o].apply(s, [t, e, i || p, p])
            }
            ,
            n.error) {
                var T = n.error;
                n.error = function(t, e, i) {
                    var s = n.context || this;
                    T.apply(s, [t, e, i, p])
                }
            }
            if (n.complete) {
            ...
            var D = i("input[type=file]:enabled", this).filter(function() {
                return "" !== i(this).val()
            })
              , _ = D.length > 0
              , k = "multipart/form-data"
              , $ = p.attr("enctype") == k || p.attr("encoding") == k
              , E = r.fileapi && r.formdata;
            o("fileAPI :" + E);
            var S, N = (_ || $) && !E;
            n.iframe !== !1 && (n.iframe || N) ? n.closeKeepAlive ? i.get(n.closeKeepAlive, function() {
                S = h(y)
            }) : S = h(y) : S = (_ || $) && E ? l(y) : i.ajax(n),
            p.removeData("jqxhr").data("jqxhr", S);
        ...
        i.fn.ajaxForm = function(t) {
            if (t = t || {},
            t.delegation = t.delegation && i.isFunction(i.fn.on),
            !t.delegation && 0 === this.length) {
                var r = {
                    s: this.selector,
                    c: this.context
                };
                return !i.isReady && r.s ? (o("DOM not ready, queuing ajaxForm"),
                i(function() {
                    i(r.s, r.c).ajaxForm(t)
                }),
                this) : (o("terminating; zero elements found by selector" + (i.isReady ? "" : " (DOM not ready)")),
                this)
            }
            return t.delegation ? (i(e).off("submit.form-plugin", this.selector, n).off("click.form-plugin", this.selector, s).on("submit.form-plugin", this.selector, t, n).on("click.form-plugin", this.selector, t, s),
            this) : this.ajaxFormUnbind().bind("submit.form-plugin", t, n).bind("click.form-plugin", t, s)
        }
        ,
        ...
        i.fn.formToArray = function(t, e) {
            ...
            if (l && !/MSIE [678]/.test(navigator.userAgent) && (l = i(l).get()),
            a && (s = i(':input[form="' + a + '"]').get(),
            s.length && (l = (l || []).concat(s))),
            !l || !l.length)
                return n;
            var h, c, u, d, p, f, g;
            for (h = 0,
            f = l.length; f > h; h++)
                ...
                u && !p.disabled)
                    ...
                    d && d.constructor == Array)
                        ...
                        null !== d && "undefined" != typeof d && (e && e.push(p),
                        n.push({
                            name: u,
                            value: d,
                            type: p.type,
            ...
            if (!t && o.clk) {
                var v = i(o.clk)
                  , y = v[0];
                u = y.name,
                u && !y.disabled && "image" == y.type && (n.push({
                    name: u,
                    value: v.val()
                }),
                n.push({
        ...
        ,
        i.fn.fieldSerialize = function(t) {
            var e = [];
            return this.each(function() {
                var n = this.name;
                if (n) {
                    var s = i.fieldValue(this, t);
                    if (s && s.constructor == Array)
                        ...
                        null !== s && "undefined" != typeof s && e.push({
                            name: this.name,
                            value: s
                        })
                }
        ...
        i.fn.fieldValue = function(t) {
            for (var e = [], n = 0, s = this.length; s > n; n++) {
                var o = this[n]
                  , r = i.fieldValue(o, t);
                null === r || "undefined" == typeof r || r.constructor == Array && !r.length || (r.constructor == Array ? i.merge(e, r) : e.push(r))
            }
            return e
        }
        ,
        i.fieldValue = function(t, e) {
            ...
            if (void 0 === e && (e = !0),
            e && (!n || t.disabled || "reset" == s || "button" == s || ("checkbox" == s || "radio" == s) && !t.checked || ("submit" == s || "image" == s) && t.form && t.form.clk != t || "select" == o && -1 == t.selectedIndex))
                return null;
            if ("select" == o) {
                var r = t.selectedIndex;
                if (0 > r)
                    return null;
                for (var a = [], l = t.options, h = "select-one" == s, c = h ? r + 1 : l.length, u = h ? r : 0; c > u; u++) {
                    var d = l[u];
                    if (d.selected) {
                        var p = d.value;
        ...
        ,
        i.fn.clearFields = i.fn.clearInputs = function(t) {
            var e = /^(?:color|date|datetime|email|month|number|password|range|search|tel|text|time|url|week)$/i;
            return this.each(function() {
                var n = this.type
                  , s = this.tagName.toLowerCase();
                e.test(n) || "textarea" == s ? this.value = "" : "checkbox" == n || "radio" == n ? this.checked = !1 : "select" == s ? this.selectedIndex = -1 : "file" == n ? /MSIE/.test(navigator.userAgent) ? i(this).replaceWith(i(this).clone(!0)) : i(this).val("") : t && (t === !0 && /hidden/.test(n) || "string" == typeof t && i(this).is(t)) && (this.value = "")
            })
        }
        ,
